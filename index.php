            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="team-member">
                  <img src="josie_img.jpg" alt="Team Member 1" class="team-member-photo">
              ...
              <div class="col-md-4">
                <div class="team-member">
                  <img src="ongshu_img.JPG" alt="Team Member 2" class="team-member-photo">
                  <h5>Ongshu Dutta</h5>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="team-member">
                  <img src="sumi_img.jpg" alt="Team Member 3" class="team-member-photo">
              ...
              <div class="col-md-4">
                <div class="team-member">
                  <img src="joaquin_img.png" alt="Team Member 4" class="team-member-photo">
                  <h5>Joaquin Garza</h5>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="team-member">
                  <img src="ibrahim_img.jpeg" alt="Team Member 5" class="team-member-photo">
              ...
              <div class="col-md-4">
                <div class="team-member">
                  <img src="michael_img.jpeg" alt="Team Member 6" class="team-member-photo">
                  <h5>Jeffrey Michael Baur</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            xhttp.onload = function() {
              if (this.readyState == 4 && this.status == 200) {
                ...
                if (response[0] === "Login successful!") {
                  ...
                  if (response[1] === "SeniorManager") {
                    window.location.href = "about:blank";
                  } else if (response[1] === "SupplyChainManager") {
                    window.location.href = "company_info_page.php";
                  } 
                } else {
                  // Display error message
                  loginMessage.textContent = response[0];
