...
$datebefore = clone $date3->modify('-1 year');
$year1 = $datebefore->format('Y');
$month1 = intval($datebefore->format('m'));

$year2 = $date4->format('Y');
$month2 = intval($date4->format('m'));

$date1_f = $date1->format('Y-m-d');
$date2_f = $date2->format('Y-m-d');
$date3_f = $date3->format('Y-m-d');
$date5 = new DateTime();
...
JOIN (
    ...
    JOIN Company c ON ic.AffectedCompanyID = c.CompanyID
    WHERE c.CompanyName = '".$companyName."'
      AND de.EventDate BETWEEN '".$date3_f."' AND '".$date2_f."'
) AS total
WHERE
    c.CompanyName = '".$companyName."'
    AND de.EventDate BETWEEN '".$date3_f."' AND '".$date2_f."'
...
WHERE t.Type = 'Shipping'
  ...
  AND (src.CompanyName = '".$companyName."'
       OR dst.CompanyName = '".$companyName."')
...
$std = array();
$avg = array();
$disruptioncategory = array();
$disruption_percentage = array();
$disruptioncategorylist = array();
$disruptiondate = array();
$ontimerate = array();
$DateR = array();
$ProductNameR = array();
$SourceCompanyNameR = array();
$DestinationCompanyNameR = array();
$QuantityR = array();
$DateS = array();
$ProductNameS = array();
$SourceCompanyNameS = array();
$DestinationCompanyNameS = array();
$QuantityS = array();
$DateA = array();
$ProductNameA = array();
$SourceCompanyNameA = array();
$DestinationCompanyNameA = array();
$QuantityA = array();
