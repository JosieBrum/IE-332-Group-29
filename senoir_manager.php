...
if(isset($categoryName) && isset($eventDate)) {
    ...
    $sql10 = "SELECT DISTINCT DisruptionCategory.CategoryName FROM DisruptionCategory";
    ...
    $result10=mysqli_query($conn,$sql10);
    $categoryNameAll = array();
    while ($row10 = mysqli_fetch_array($result10)) {
        $categoryNameAll[] = $row10['CategoryName'];   
    }
    $output['List of All categories'] = $categoryNameAll; 
}
