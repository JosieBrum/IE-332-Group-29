  ...
  <script>
    ...
    function getContinentList() {
      ...
      if (continentListPromise === null) {
        continentListPromise = fetch('disruption_events_output.php?continent=&date1=2019-01-01&date2=2019-01-02')
    ...
    function showCustomer(event) {
      ...
      var url = "disruption_events_output.php?" + new URLSearchParams(inputs).toString();
      console.log(url);
